...
CFLAGS += -Wall -std=c++20 -D_DEFAULT_SOURCE -Wno-missing-braces -Wno-deprecated-enum-enum-conversion -fopenmp
...
$(PROJECT_NAME): $(OBJS)
	$(CC) -o $(PROJECT_NAME)$(EXT) $(OBJS) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM) $(RAYLIB_PATH)/src/raylib.rc.data
